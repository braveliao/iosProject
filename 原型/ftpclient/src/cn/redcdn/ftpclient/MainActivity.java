...
import cn.redcdn.ftpclient.UploadFileChooserAdapter.FileInfo;
...
//			return true;
	...
	private Dialog createFTPLoginDialog() {
		...
		//test data
		editHost.setText("192.168.1.106");
		editUser.setText("liaoyong");
		editPasword.setText("redcdn");
